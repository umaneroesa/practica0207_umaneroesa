#El fichero calificaciones.csv contiene las calificaciones de un curso. Durante el curso se realizan dos exámenes parciales de teoría y un examen de prácticas. Los alumnos que tengan menos de 4 en alguno de estos exámenes pueden repetirlo al final del curso (convocatoria ordinaria). Escribir un programa que contenga las siguientes funciones:
import os
file=open("calificaciones", "w")
def nota(cifra):
